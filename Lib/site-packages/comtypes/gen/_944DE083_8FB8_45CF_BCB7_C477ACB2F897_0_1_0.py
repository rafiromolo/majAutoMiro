...
__all__ = [
    ...
    'UIA_ScrollVerticalViewSizePropertyId', 'IUIAutomationElement',
    'UIA_DataGridControlTypeId', 'UIA_ItemContainerPatternId',
    'UIA_EditControlTypeId', 'UIA_AnimationStyleAttributeId',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_WindowCanMaximizePropertyId', 'UIA_Text_TextChangedEventId',
    'UIA_SeparatorControlTypeId', 'UIA_ProviderDescriptionPropertyId',
    'UIA_TabItemControlTypeId', 'TreeScope_Descendants',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_TextControlTypeId', 'UIA_LayoutInvalidatedEventId',
    'IUIAutomationSynchronizedInputPattern', 'DockPosition_None',
    'ProviderOptions_ClientSideProvider',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_SpinnerControlTypeId', 'UIA_LabeledByPropertyId',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_LegacyIAccessiblePatternId', 'UIA_ToolTipClosedEventId',
    'UIA_ControllerForPropertyId', 'UIA_ToolTipOpenedEventId',
    'UIA_IsControlElementPropertyId', 'UIA_OverlineStyleAttributeId',
    'UIA_Text_TextSelectionChangedEventId',
    'RowOrColumnMajor_RowMajor', 'UIA_AutomationFocusChangedEventId',
    'UIA_SliderControlTypeId', 'UIA_GridItemRowSpanPropertyId',
    'UIA_CheckBoxControlTypeId', 'SupportedTextSelection_None',
    'UIA_GridItemPatternId', 'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_NamePropertyId', 'UIA_IsHiddenAttributeId',
    'StructureChangeType_ChildrenReordered', 'UIA_ValuePatternId',
    'UIA_TextPatternId', 'IUIAutomationCacheRequest',
    'UIA_ComboBoxControlTypeId', 'UIA_ListControlTypeId',
    'UIA_TransformCanMovePropertyId', 'PropertyConditionFlags',
    'TextPatternRangeEndpoint_Start', 'ScrollAmount_LargeDecrement',
    'UIA_OutlineStylesAttributeId', 'CUIAutomation',
    'TreeScope_Parent', 'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_ToolTipControlTypeId', 'UIA_FontWeightAttributeId',
    'UIA_Window_WindowClosedEventId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'IUIAutomationLegacyIAccessiblePattern', 'UIA_CultureAttributeId',
    'IUIAutomationProxyFactoryMapping', 'UIA_MarginBottomAttributeId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'IUIAutomationScrollItemPattern', 'UIA_TableItemPatternId',
    'UIA_MenuModeStartEventId', 'DockPosition_Fill',
    'SupportedTextSelection', 'UIA_MenuModeEndEventId',
    'WindowInteractionState_NotResponding',
    'UIA_DocumentControlTypeId', 'UIA_PaneControlTypeId',
    'TextUnit_Format', 'IUIAutomationElementArray',
    'SynchronizedInputType_RightMouseUp',
    'IUIAutomationProxyFactoryEntry', 'UIA_TabsAttributeId',
    'TreeScope_Ancestors', 'UIA_TogglePatternId',
    'IUIAutomationTextPattern', 'WindowInteractionState_Running',
    'UIA_BoundingRectanglePropertyId', 'UIA_TitleBarControlTypeId',
    ...
    'UIA_MultipleViewPatternId', 'WindowVisualState_Maximized',
    'UIA_ListItemControlTypeId', 'UIA_DockDockPositionPropertyId',
    'IUIAutomationInvokePattern', 'IUIAutomationNotCondition',
    'ExpandCollapseState_Expanded', 'UIA_TabControlTypeId',
    'IUIAutomationRangeValuePattern',
    'UIA_IsDockPatternAvailablePropertyId', 'UIA_ThumbControlTypeId',
    'UIA_RangeValueMaximumPropertyId',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_IsContentElementPropertyId', 'UIA_MenuOpenedEventId',
    ...
    'AutomationElementMode_Full', 'UIA_StrikethroughColorAttributeId',
    'ScrollAmount_LargeIncrement',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_TableColumnHeadersPropertyId', 'UIA_InputDiscardedEventId',
    'UIA_WindowIsModalPropertyId', 'OrientationType_Horizontal',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'WindowVisualState_Normal', 'UIA_ImageControlTypeId',
    'UIA_IsSubscriptAttributeId', 'UIA_UnderlineColorAttributeId',
    'UIA_InputReachedOtherElementEventId',
    'UIA_IndentationFirstLineAttributeId',
    'IUIAutomationEventHandler', 'TextPatternRangeEndpoint_End',
    'UIA_StatusBarControlTypeId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'IUIAutomationOrCondition', 'SynchronizedInputType_KeyUp',
    'UIA_TreeItemControlTypeId', 'TreeScope_Subtree',
    'UIA_TableRowHeadersPropertyId', 'UIA_FlowsToPropertyId',
    'UIA_DescribedByPropertyId', 'UIA_ToolBarControlTypeId',
    'SupportedTextSelection_Multiple',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_HasKeyboardFocusPropertyId', 'IUIAutomationTreeWalker',
    'SynchronizedInputType_KeyDown', 'AutomationElementMode',
    'IUIAutomationStructureChangedEventHandler', 'ToggleState_On',
    'IUIAutomationWindowPattern', 'UIA_WindowCanMinimizePropertyId',
    'UIA_UnderlineStyleAttributeId', 'UIA_AutomationIdPropertyId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_ClassNamePropertyId',
    'UIA_IsInvokePatternAvailablePropertyId', 'UIA_TablePatternId',
    'ExpandCollapseState', 'PropertyConditionFlags_IgnoreCase',
    'UIA_ForegroundColorAttributeId', 'DockPosition_Right',
    'TextUnit_Page', 'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_GroupControlTypeId', 'UIA_RangeValuePatternId',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_MarginLeadingAttributeId', 'UIA_ScrollPatternId',
    'UIA_ControlTypePropertyId', 'UIA_GridItemColumnSpanPropertyId',
    'UIA_IsReadOnlyAttributeId',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_AutomationPropertyChangedEventId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_AriaRolePropertyId', 'UIA_MenuControlTypeId',
    'UIA_HyperlinkControlTypeId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_SelectionSelectionPropertyId', 'ToggleState_Indeterminate',
    'UIA_TreeControlTypeId', 'IUIAutomationItemContainerPattern',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'IUIAutomationPropertyCondition',
    'UIA_StrikethroughStyleAttributeId', 'UIA_SelectionItemPatternId',
    'DockPosition', 'UIA_GridItemContainingGridPropertyId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_AriaPropertiesPropertyId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'StructureChangeType', 'UIA_SplitButtonControlTypeId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_AsyncContentLoadedEventId', 'UIA_ItemStatusPropertyId',
    ...
    'UIA_ValueIsReadOnlyPropertyId', 'UIA_GridItemColumnPropertyId',
    'UIA_LegacyIAccessibleHelpPropertyId', 'DockPosition_Left',
    'UIA_ProcessIdPropertyId', 'UIA_IsItalicAttributeId',
    'UIA_CustomControlTypeId', 'UIA_ExpandCollapsePatternId',
    'AutomationElementMode_None', 'OrientationType_None',
    'UIA_ScrollItemPatternId', 'UIA_GridItemRowPropertyId',
    'UIA_IsEnabledPropertyId', 'OrientationType_Vertical',
    'UIA_NativeWindowHandlePropertyId', 'SynchronizedInputType',
    'UIA_LegacyIAccessibleValuePropertyId',
    'WindowVisualState_Minimized', 'WindowInteractionState_Closing',
    'UIA_MarginTopAttributeId', 'ExpandCollapseState_LeafNode',
    'UIA_AcceleratorKeyPropertyId', 'IUIAutomation',
    'UIA_GridColumnCountPropertyId', 'TextUnit_Document',
    'IUIAutomationTableItemPattern', 'UIA_GridPatternId',
    'UIA_StructureChangedEventId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'IRawElementProviderSimple', 'IUIAutomationCondition',
    'UIA_IsGridPatternAvailablePropertyId', 'WindowVisualState',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_GridRowCountPropertyId', 'IUIAutomationTogglePattern',
    'UIA_TableRowOrColumnMajorPropertyId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'StructureChangeType_ChildRemoved', 'TextUnit',
    'WindowInteractionState', 'StructureChangeType_ChildAdded',
    'ProviderOptions_ServerSideProvider',
    'UIA_Window_WindowOpenedEventId',
    'ProviderOptions_NonClientAreaProvider', 'DockPosition_Top',
    'UIA_FontSizeAttributeId', 'UIA_RangeValueMinimumPropertyId',
    'IUIAutomationValuePattern',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_HeaderControlTypeId', 'IUIAutomationSelectionItemPattern',
    'UIA_MenuBarControlTypeId', 'ScrollAmount_NoAmount',
    'IUIAutomationAndCondition',
    'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_RangeValueSmallChangePropertyId',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_IndentationLeadingAttributeId', 'IUIAutomationProxyFactory',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'ProviderOptions_UseComThreading', 'IAccessible',
    'ScrollAmount_SmallIncrement', 'RowOrColumnMajor', 'ToggleState',
    'UIA_IsGridItemPatternAvailablePropertyId', 'UIA_DockPatternId',
    'UIA_FrameworkIdPropertyId', 'UIA_IsPasswordPropertyId',
    'IUIAutomationDockPattern', 'UIA_RuntimeIdPropertyId',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_CulturePropertyId',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_ItemTypePropertyId', 'UIA_TransformPatternId',
    'UIA_IsOffscreenPropertyId', 'UIA_HeaderItemControlTypeId',
    'UIA_BulletStyleAttributeId',
    'UIA_LegacyIAccessibleRolePropertyId', 'TextPatternRangeEndpoint',
    'TextUnit_Line', 'ToggleState_Off',
    'ProviderOptions_OverrideProvider',
    'UIA_IsKeyboardFocusablePropertyId',
    'IUIAutomationTextRangeArray',
    'UIA_IndentationTrailingAttributeId', 'UIA_SelectionPatternId',
    'IUIAutomationGridPattern', 'UIA_FontNameAttributeId',
    'UIA_AccessKeyPropertyId', 'UIA_IsSuperscriptAttributeId',
    'UIA_WindowPatternId',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_WindowControlTypeId', 'UIA_ProgressBarControlTypeId',
    'UIA_RangeValueValuePropertyId', 'DockPosition_Bottom',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'PropertyConditionFlags_None', 'TextUnit_Paragraph',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'SynchronizedInputType_LeftMouseUp',
    'UIA_Selection_InvalidatedEventId', 'IUIAutomationTextRange',
    'UIA_MarginTrailingAttributeId', 'TreeScope_Children',
    'UIA_TableControlTypeId', 'TreeScope_Element',
    'IUIAutomationExpandCollapsePattern',
    'UIA_InputReachedTargetEventId', 'IUIAutomationGridItemPattern',
    'UIA_InvokePatternId', 'UIA_MenuClosedEventId', 'ScrollAmount',
    'IUIAutomationFocusChangedEventHandler',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_MenuItemControlTypeId', 'IUIAutomationTransformPattern',
    'UIA_LegacyIAccessibleChildIdPropertyId', 'ProviderOptions',
    'UIA_ToggleToggleStatePropertyId',
    'ExpandCollapseState_Collapsed', 'OrientationType', 'TreeScope',
    'UIA_LegacyIAccessibleStatePropertyId',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_ScrollBarControlTypeId', 'TextUnit_Word',
    'UIA_RadioButtonControlTypeId', 'UIA_OrientationPropertyId',
    'UIA_DataItemControlTypeId', 'IUIAutomationSelectionPattern',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_HelpTextPropertyId', 'ProviderOptions_ProviderOwnsSetFocus',
    'IUIAutomationScrollPattern', 'RowOrColumnMajor_ColumnMajor',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_ValueValuePropertyId', 'RowOrColumnMajor_Indeterminate',
    'IUIAutomationMultipleViewPattern',
    'UIA_BackgroundColorAttributeId', 'IUIAutomationTablePattern',
    'UIA_IsTablePatternAvailablePropertyId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_TransformCanRotatePropertyId', 'IUIAutomationBoolCondition',
    'UIA_Invoke_InvokedEventId', 'UIA_TransformCanResizePropertyId'
]

_check_version('1.2.1', 1247534177.020000)
