...
__all__ = [
    'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_PIXELS', 'Gray', 'Color',
    'FONTBOLD', 'OLE_XPOS_CONTAINER', 'LoadPictureConstants',
    'FONTNAME', 'StdPicture', 'FONTUNDERSCORE', 'OLE_TRISTATE',
    'Default', 'OLE_YPOS_PIXELS', 'OLE_XSIZE_CONTAINER',
    'OLE_YPOS_HIMETRIC', 'OLE_XPOS_PIXELS', 'Checked', 'IPicture',
    'OLE_ENABLEDEFAULTBOOL', 'IPictureDisp', 'OLE_YPOS_CONTAINER',
    'OLE_XSIZE_HIMETRIC', 'IFontEventsDisp', 'StdFont', 'Font',
    'FONTSTRIKETHROUGH', 'IFontDisp', 'OLE_XPOS_HIMETRIC', 'Picture',
    'FONTSIZE', 'OLE_HANDLE', 'FontEvents', 'FONTITALIC', 'VgaColor',
    'IFont', 'OLE_OPTEXCLUSIVE', 'OLE_COLOR', 'Monochrome',
    'OLE_CANCELBOOL', 'OLE_YSIZE_HIMETRIC', 'OLE_YSIZE_PIXELS',
    'Unchecked'
]

_check_version('1.2.1', 1247528633.409106)
